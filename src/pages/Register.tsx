...
import { Mail, Lock, X, Eye, EyeOff, AlertCircle, User, LogIn, Github } from 'lucide-react';
...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Image */}
      <div className="hidden lg:block lg:w-1/2 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1481535668376-4c3ab7d84e7d?ixid=M3w3MjUzNDh8MHwxfHNlYXJjaHwyfHxsb2dpbiUyMHJlZ2lzdHJhdGlvbiUyMGZvcm0lMjBtb2Rlcm4lMjB1aXxlbnwwfHx8fDE3NDg2MDMwNzh8MA&ixlib=rb-4.1.0&fit=fillmax&h=600&w=800')` }}>
        <div className="h-full w-full bg-black bg-opacity-20 flex items-center justify-center p-12">
          <div className="max-w-xl text-white">
            ...
            >
              <h2 className="text-4xl font-bold mb-6">Join thousands of users creating amazing QR codes</h2>
              <p className="text-lg mb-8">Register now to save your QR codes, track scans, and access premium features.</p>
              <div className="flex">
